...
WICHTIG FÜR QUELLEN:
- Wenn du eine externe Quelle hast, gib die vollständige URL an (z.B. "https://beispiel.com/artikel")
- Wenn es eine Annahme ist, schreib "Assumption: [Beschreibung]"
- Wenn es Marktdaten sind, schreib die konkrete Quelle (z.B. "https://statista.com/..." oder "https://gartner.com/...")
- Quellen müssen clickbar sein, KEINE Google-Suchbegriffe!

Antworte mit VALID JSON (no other text):
{
  "analysis": "[2-3 Sätze neutrale Analyse]",
  "sources": ["https://[konkrete-url]", "Assumption: [wenn basierend auf Annahme]"],
  "assumptions": ["Annahme 1", "Annahme 2"],
  "counter_arguments": ["Gegenperspektive 1"],
  "signal": "Stark"
}

Use only these signal values: "Stark", "Mittel", or "Schwach".""",
...
Ergebnisse der vier Dimensionen (already parsed):
...
Aufgabe:
1. Erstelle eine kurze Übersicht der 4 Dimensionen
2. Identifiziere die 2-3 stärksten Validierungssignale
3. Nenne bis zu 2 kritische Wissenslücken oder Risiken
4. Gib eine Gesamtbewertung: Ist das Problem validiert? (Ja/Nein/Teilweise)

WICHTIG FÜR QUELLEN:
- Wenn du externe Quellen zitierst, gib die vollständige URL an
- Wenn es Annahmen sind, schreib "Assumption: [Beschreibung]"
- Quellen müssen clickbar sein, KEINE Google-Suchbegriffe!

Antworte mit VALID JSON (no other text):
{
  "analysis": "[2-3 Absätze Synthese und Bewertung]",
  "sources": ["https://[konkrete-url]", "Assumption: [wenn basierend auf Annahme]"],
  "assumptions": ["Kritische Annahme 1"],
  "counter_arguments": ["Gegenperspektive oder Risikobereich 1"],
  "signal": "Stark"
}
